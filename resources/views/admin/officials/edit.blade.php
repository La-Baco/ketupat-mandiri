...
@section('title', 'Edit Aparatur Desa')

@section('content')
<div class="mb-6 flex justify-between items-center">
    <div>
        <h2 class="text-2xl font-bold text-slate-800 font-outfit">Edit Aparatur Desa</h2>
        <p class="text-sm text-slate-500 mt-1">Perbarui data perangkat desa atau staf.</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 space-y-6">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $official->name) }}" required class="block w-full rounded-xl border-slate-200 bg-slate-50 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-4 py-2.5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="position" value="{{ old('position', $official->position) }}" required class="block w-full rounded-xl border-slate-200 bg-slate-50 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-4 py-2.5">
                    ...
                    <div>
                        ...
                        <input type="text" name="nip" value="{{ old('nip', $official->nip) }}" class="block w-full rounded-xl border-slate-200 bg-slate-50 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-4 py-2.5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="5" class="block w-full rounded-xl border-slate-200 bg-slate-50 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-4 py-3">{{ old('description', $official->description) }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="education" value="{{ old('education', $official->education) }}" class="block w-full rounded-xl border-slate-200 bg-slate-50 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-4 py-2.5">
                    ...
                    <div>
                        ...
                        <input type="text" name="work_experience" value="{{ old('work_experience', $official->work_experience) }}" class="block w-full rounded-xl border-slate-200 bg-slate-50 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-4 py-2.5">
            ...
            <div class="space-y-6">
                <div class="bg-slate-50 p-5 rounded-xl border border-slate-100">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="is_active" class="block w-full rounded-lg border-slate-200 bg-white shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-3 py-2">
                            <option value="1" {{ old('is_active', $official->is_active) == '1' ? 'selected' : '' }}>Aktif (Tampilkan)</option>
                            <option value="0" {{ old('is_active', $official->is_active) == '0' ? 'selected' : '' }}>Nonaktif (Sembunyikan)</option>
                        </select>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-slate-700 mb-2">Urutan Tampil (Angka)</label>
                        <input type="number" name="order_number" value="{{ old('order_number', $official->order_number) }}" min="1" required class="block w-full rounded-lg border-slate-200 bg-white shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-3 py-2">
                ...
                <div class="bg-slate-50 p-5 rounded-xl border border-slate-100">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-2">Upload Foto Baru (Opsional)</label>
                        
                        @if($official->photo)
                        <div class="mb-3 relative group w-32 h-32">
                            <img src="{{ Storage::url($official->photo) }}" class="w-full h-full object-cover rounded-xl border border-slate-200 shadow-sm">
                        </div>
                        @endif
                        ...
                        <p class="text-xs text-slate-400 mt-2">Biarkan kosong jika tidak ingin mengubah foto profil.</p>
                    </div>
                </div>
