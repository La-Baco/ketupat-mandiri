...
<div class="mb-6 flex justify-between items-center">
    <div>
        <h2 class="text-2xl font-bold text-slate-800 font-outfit">Berita</h2>
        <p class="text-sm text-slate-500 mt-1">Kelola publikasi dan artikel berita desa.</p>
    </div>
    <a href="{{ route('admin.news.create') }}" class="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors">
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-slate-50 border-b border-slate-200 text-xs uppercase text-slate-500 font-semibold tracking-wider">
                    ...
                    <th class="px-6 py-4">Tgl Publikasi</th>
            ...
            <tbody class="divide-y divide-slate-100 text-sm">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        <a href="{{ route('admin.news.edit', $item->id) }}" class="inline-flex items-center p-2 bg-slate-100 hover:bg-teal-50 text-slate-600 hover:text-teal-600 rounded-lg transition-colors" title="Edit">
