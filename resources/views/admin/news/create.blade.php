...
<div class="mb-6 flex justify-between items-center">
    <div>
        <h2 class="text-2xl font-bold text-slate-800 font-outfit">Tambah Berita</h2>
        <p class="text-sm text-slate-500 mt-1">Buat publikasi berita baru.</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div>
                    ...
                    <!-- Gunakan library WYSIWYG seperti Trix, CKEditor, atau TinyMCE di sini (ini fallback textarea) -->
                    <textarea name="content" rows="15" required class="block w-full rounded-xl border-slate-200 bg-slate-50 shadow-sm focus:border-teal-500 focus:ring focus:ring-teal-500/20 px-4 py-3">{{ old('content') }}</textarea>
